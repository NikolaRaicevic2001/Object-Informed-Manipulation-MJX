...
```bash
python examples/pusht_real.py --mock --scene box_clutter --steps 200 \
    --command-mode stream
```
...
python examples/pusht_real.py --scene box_clutter --dry-run --steps 1 --warp

# Live
python examples/pusht_real.py --scene box_clutter --steps 200 \
